...
The repository includes a versioned Codex skill at
`skills/djot-semantic-notes`. It teaches LLM agents how to create and edit
Djot notes that follow this release’s `djot-tools` semantics, especially task
attributes, task references, dependencies, and recurring task advancement.

When installed through Nix, the skill is available under
`share/djot-tools/skills/djot-semantic-notes` in the package output. Copy or
symlink that directory into your Codex skills directory, for example:
